      ...
      <el-form label-position="top">
        ...
        <template v-if="localConfig.live2dEnabled">
          <el-form-item label="模型路径">
            <el-input
              v-model="localConfig.live2dPath"
              placeholder="支持在线URL或 /xxx.model3.json"
            />
          </el-form-item>

          <el-form-item label="模型大小 (缩放比例)">
            <el-slider
              v-model="localConfig.live2dScale"
              :min="0.5"
              :max="3"
              :step="0.1"
              show-input
